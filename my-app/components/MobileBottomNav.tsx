          ...
          >
            <div className="flex items-center justify-between mb-4 pb-3 border-b border-border">
              <div className="flex items-center gap-3">
                ...
                />
                <div>
                  <span className="block text-sm font-bold text-foreground font-heading">
                    PICSEL
                  </span>
            ...
            {moreLinks.map((link) => (
              <Link
                ...
                href={link.path}
                onClick={() => setShowMore(false)}
                className={`flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium transition-colors ${isActive(link.path)
          ...
          {mainTabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center gap-1 rounded-xl px-4 py-1.5 transition-colors ${active ? "text-primary" : "text-muted-foreground"
                  }`}
              >
